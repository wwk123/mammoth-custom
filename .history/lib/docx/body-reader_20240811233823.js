 ...
 * @Date: 2023-02-27 22:07:10
 * @LastEditors: wangwenke m17600463015@163.com
 * @LastEditTime: 2024-08-11 23:38:22
 * @FilePath: \mammoth-custom\lib\docx\body-reader.js
...
function BodyReader(options) {
    ...
    function readRunProperties(element) {
        return readRunStyle(element).map(function(style) {
            ...
            var properties = styleUtils.readRunProperties(element);
            return Object.assign({}, styleOptions, properties);
        });
    }
    ...
    function reaBodyPageProperties(element) {
        var page = {
            ...
            borders: readTableCellBorders(element.firstOrEmpty('w:pgBorders')), // w:pgBorders
            textDirection: element.firstOrEmpty('w:pgBorders').attributes['w:val'] // <w:textDirection w:val="lrTb"/>
        };
    ...
    function readStyle(element, styleTagName, styleType, findStyleById) {
        ...
        if (styleElement) {
            ...
            if (styleId) {
                ...
                if (style) {
                    var basedStyleId = style['basedOn'];
                    if (basedStyleId) {
                        basedStyle = findStyleById(basedStyleId);
                    }
                    styleResult.name = style.name;
                } else {
        ...
        return elementResultWithMessages(Object.assign({}, basedStyle, styleResult), messages);
    }
    ...
    var xmlElementReaders = {
        ...
        "w:pPr": function(element) {
            return readParagraphStyle(element).map(function(style) {
                ...
                var properties = Object.assign({}, paragraphProp, styleUtils.readParagraphProperties(element), style);
                return filterObject(properties);
            });
        },
    ...
    function readTableProperties(element, elements) {
        return readTableStyle(element).map(function(style) {
            ...
            var styleMap = styleUtils.readTableProperties(element, elements);
            return Object.assign({}, tableProp, styleMap);
        });
    }
    ...
    function readTableCellProperties(element) {
        ...
        return {
            ...
            textDirection: element.firstOrEmpty("w:textDirection").attributes['w:val']
        };
    }
