        ...
        .then(function(docxFile) {
            return docxReader.read(docxFile, input)
                .then(function(documentResult) {
                    console.log(documentResult, 'documentResult docxReader reader')
                    return documentResult.map(options.transformDocument);
                })
                .then(function(documentResult) {
                    console.log(documentResult, 'documentResult transformDocument')
                    return convertDocumentToHtml(documentResult, options).then(function(result) {
                        console.log(documentResult, result, 'documentResult')
                        return {
