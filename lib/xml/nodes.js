...
exports.element = function(name, attributes, children, previousSibling) {
    return new Element(name, attributes, children, previousSibling);
};
...
function Element(name, attributes, children, previousSibling) {
    this.type = "element";
    this.name = name;
